...
# extra-synth data
python src/preprocess.py -c config/feature/${TARGET}.yaml -a /home/data/kbh/DCASE2022/v1/foa -m /home/data/kbh/DCASE2022/v1/metadata -o /home/data/kbh/DCASE2022/

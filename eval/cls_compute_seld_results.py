...
class ComputeSELDResults(object):
    def __init__(
            self, params, ref_files_folder=None, use_polar_format=False, synth=True
    ):
...
if __name__ == "__main__":
    pred_output_format_files = '/home/data/kbh/DCASE2022/out/d0_v2/' # Path of the DCASEoutput format files
